...
class _DriverHomePageState extends State<DriverHomePage>
  ...
  Widget _buildNetworkImage() {
    ...
    if (avatarUrl != null && avatarUrl.isNotEmpty) {
      final imageUrl =
          AppConfig.apiBaseUrl.replaceFirst('/api', '') + avatarUrl;
                          ...
                          isWeb && (isDesktop || isTablet)
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            ...
                                            _queueKey.currentState?.refresh());
                                      },
                                    ),
                                    _buildActionCard(
                              ...
                              : Column(
                                  children: [
                                    ...
                                    SizedBox(
                                        height: isSmallScreen ? 12.0 : 16.0),
                                    Row(
                                      children: [
                                        Expanded(
                                          child: _buildActionCard(
