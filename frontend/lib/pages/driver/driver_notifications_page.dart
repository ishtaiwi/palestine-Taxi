...
class _DriverNotificationsPageState extends State<DriverNotificationsPage> {
  ...
  final Map<String, Map<String, String>> _texts = {
    'ar': {
      ...
      'noNotificationsSub': 'سنخبرك عند وجود طلبات أو تحديثات جديدة',
    ...
    'en': {
      ...
      'noNotificationsSub': 'We\'ll let you know about new requests or updates',
  ...
  void _handleNotificationTap(NotificationModel notification) {
    ...
    if (data != null) {
      if (data['action'] == 'view_trip' && data['tripid'] != null) {
        ...
        // Navigator.push(...);
      } else if (data['action'] == 'view_payment' &&
          data['paymentid'] != null) {
